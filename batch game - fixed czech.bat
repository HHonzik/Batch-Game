...
cls
:start_game
if exist %save_cd% (goto :save_found)
:dont_load_save
set money=0
set house=0
set backpack=
...
choice /N /C "125ESD"
if "%errorlevel%" == "1" (goto :backpack)
if "%errorlevel%" == "2" (goto :walk)
if "%errorlevel%" == "4" (goto :exit)
if "%errorlevel%" == "5" (goto :save)
if "%errorlevel%" == "3" (goto :buy)
if "%errorlevel%" == "6" (goto :in_house)
goto :choice

:walk
SET /A money_get=%RANDOM% * 100 / 32768
SET /A rand=%RANDOM% * 10 / 32768
if "%rand%" == "5" (goto :money_got)
if "%rand%" == "3" (goto :found_paper)
goto :choice
